...
<div x-data="{ userMenuOpen: false, draftsOpen: false, drafts: [], loadingDrafts: false }" class="flex items-center gap-4">
    ...
    <!-- Steps Progress - Only show on request pages -->
    @if(request()->is('publications/request') || request()->is('citations/request'))
    <div class="flex items-center gap-2 px-3 py-2 text-xs font-medium text-gray-700 bg-white border border-gray-200 rounded-lg h-8">
        <div class="flex items-center gap-2">
            <div class="w-6 h-6 bg-maroon-600 rounded-lg flex items-center justify-center">
        ...
        <div class="flex items-center gap-2">
            <div class="w-6 h-6 bg-gray-300 rounded-lg flex items-center justify-center">
                <span class="text-gray-500 font-bold text-xs">2</span>
            </div>
            <span class="text-gray-500 font-medium">Upload</span>
        </div>
        <div class="w-6 h-0.5 bg-gray-300"></div>
        <div class="flex items-center gap-2">
            <div class="w-6 h-6 bg-gray-300 rounded-lg flex items-center justify-center">
