            ...
            <div class="relative z-10 pt-16">
                <main>
                            ...
                            <div class="w-64 h-full flex flex-col justify-center">
                                <div class="side-floating-card h-full bg-white/40 backdrop-blur-md border border-white/40 rounded-xl shadow-2xl p-6 flex flex-col items-center justify-center">
                                    ...
                                    <div class="mb-2 flex items-center justify-center">
                                        <svg class="w-10 h-10 text-maroon-800 drop-shadow-lg" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 20l9-5-9-5-9 5 9 5zm0 0V4" />
                                        </svg>
                                    </div>
                                    <h2 class="text-xl font-bold text-maroon-800 mb-1">Total Indexed Journals</h2>
                                    <div class="text-5xl font-extrabold text-maroon-700 mb-4 drop-shadow transition-transform duration-300 group-hover:scale-110">27</div>
                                    ...
                                    <div class="flex-1 overflow-y-auto w-full flex flex-col gap-0.5 relative px-0" style="overflow: visible;">
                                         ...
                                         <div class="flex items-center gap-2 bg-white/80 rounded-xl p-2 w-full border-b border-maroon-800/10 last:border-b-0 group hover:bg-white/90 transition-all cursor-pointer min-h-[3.5rem]">
                                             ...
                                             <div class="flex flex-col w-full">
                                                 ...
                                                 <span class="text-xs text-gray-700 leading-snug line-clamp-3">Welcome to the new Publications Portal.</span>
                                             </div>
                                         </div>
                                    </div>
                    ...
                    <div class="text-center mb-6">
                        ...
                        <h1 class="text-3xl font-extrabold text-maroon-900 mb-2">Welcome to USeP Publications Unit</h1>
                        <p class="text-lg text-maroon-900 font-semibold mb-3 drop-shadow-sm">
                    ...
                    <div class="grid md:grid-cols-3 gap-4 mb-6">
                        <div>
                            <a href="#" class="block text-center p-4 bg-white/30 backdrop-blur-md border border-white/40 rounded-2xl shadow-xl
                                ...
                                <h3 class="text-base font-semibold text-maroon-800 mb-1">Service 1</h3>
                        ...
                        <div>
                            <a href="#" class="block text-center p-4 bg-white/30 backdrop-blur-md border border-white/40 rounded-2xl shadow-xl
                                ...
                                <h3 class="text-base font-semibold text-maroon-800 mb-1">List of Researchers</h3>
                        ...
                        <div>
                            <a href="{{ route('login') }}" class="block text-center p-4 bg-white/30 backdrop-blur-md border border-white/40 rounded-2xl shadow-xl
                                ...
                                <h3 class="text-base font-semibold text-maroon-800 mb-1">Application Portal</h3>
