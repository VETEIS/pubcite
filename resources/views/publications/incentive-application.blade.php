...
<div class="space-y-6">
    ...
    <div class="bg-white/50 backdrop-blur-sm rounded-xl border border-gray-200 p-6 shadow-sm">
        <div class="flex items-center gap-3 mb-6">
            ...
            <h4 class="text-lg font-semibold text-gray-900">II. Publication Details</h4>
        </div>
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-2">
                    <label class="block text-sm font-medium text-gray-700">
                        ISSN (P-ISSN/E-ISSN) <span class="text-red-500">*</span>
                    </label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        <div class="h-12 flex items-center justify-center">
                            <p class="text-sm font-medium text-gray-700 text-center" id="faculty-name-display">{{ strtoupper(old('name', $request->form_data['name'] ?? '')) }}</p>
