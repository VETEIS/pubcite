                    ...
                    <div class="p-6">
                        ...
                        >
                            ...
                            <div class="flex border-b border-gray-200 mb-6 bg-white rounded-t-lg">
                                ...
                                <button type="button" 
                                    class="flex-1 px-4 py-3 text-sm font-medium text-center border-b-2 transition-all duration-200"
                                    :class="activeTab === 'terminal' ? 'border-maroon-600 text-maroon-700 bg-maroon-50' : isTabEnabled('terminal') ? 'border-transparent text-gray-500 hover:text-gray-700 hover:bg-gray-50' : 'border-transparent text-gray-400 cursor-not-allowed bg-gray-100'"
