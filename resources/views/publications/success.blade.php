...
<div class="max-w-xl mx-auto p-8 bg-white rounded shadow mt-12 text-center">
    ...
    <a href="{{ route('publications.incentive.review') }}" data-turbo="false" class="ml-4 bg-gray-300 text-gray-800 px-6 py-2 rounded hover:bg-gray-400">Start New Request</a>
</div>
@endsection 