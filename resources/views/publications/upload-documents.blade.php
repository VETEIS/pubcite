...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white/50 backdrop-blur-sm rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-all duration-200 group cursor-pointer flex flex-col h-full"
        ...
        <div class="bg-white/50 backdrop-blur-sm rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-all duration-200 group cursor-pointer flex flex-col h-full"
            ...
            <div class="text-center flex flex-col h-full">
                <div class="flex-1">
                    ...
                    <p class="text-sm text-gray-600 mb-4">Peer review document (PDF)</p>
                </div>
                <div class="mt-auto">
                    <div class="text-sm text-maroon-600 font-medium mb-2 truncate" x-text="displayName || 'Click to upload'"></div>
                    <p class="text-xs text-gray-500">Max 20MB • PDF only</p>
