        ...
        function citationRequestData() {
            return {
                ...
                switchTab(targetTab) {
                    ...
                    // Auto-generate DOCX files when upload tab becomes active (all forms filled)
                    if (targetTab === 'upload') {
                        this.$nextTick(() => {
                            // Start background generation for both documents
                            this.autoGenerateDocxFiles();
                        });
                    }
        ...
        const form = document.getElementById('citation-request-form');
            ...
            const fileFields = [
                ...
                calculateFormDataHash(tabType) {
                    ...
                    const tabFields = {
                        'incentive': ['name', 'rank', 'college', 'bibentry', 'citedbibentry', 'issn', 'doi', 'scopus', 'wos', 'aci', 'faculty_name', 'center_manager', 'dean_name', 'date'],
                ...
                setupFormChangeListeners() {
                    ...
                    const incentiveFields = ['name', 'rank', 'college', 'bibentry', 'citedbibentry', 'issn', 'doi', 'scopus', 'wos', 'aci', 'faculty_name', 'center_manager', 'dean_name', 'date'];
