<!-- Modern Recommendation Letter Form -->
<div class="space-y-6">
    <!-- Header Section -->
    <div class="text-center py-6 bg-gradient-to-r from-maroon-50 to-burgundy-50 rounded-xl border border-maroon-200">
        ...
        <h3 class="text-lg font-semibold text-maroon-700">Recommendation Letter for Citation Incentive</h3>
    </div>
                            ...
                            <tr>
                                <td class="p-4 align-top">
                                    <textarea name="rec_citing_details" id="rec_citing_details" rows="4" 
                                              ...
                                              placeholder="Enter bibliographic details of the citing article" required></textarea>
                                </td>
                                <td class="p-4 align-top">
